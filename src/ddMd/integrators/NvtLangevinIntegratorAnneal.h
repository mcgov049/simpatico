#ifndef DDMD_NVT_LANGEVIN_INTEGRATOR_ANNEAL_H
#define DDMD_NVT_LANGEVIN_INTEGRATOR_ANNEAL_H
...
namespace DdMd
{
   ...
   * 
   * \sa \ref ddMd_integrator_NvtLangevinIntegratorAnneal_page "parameter file format"
   * \sa \ref algorithms_Langevin_page "algorithm"
   * \ingroup DdMd_Integrator_Module
   */
   class NvtLangevinIntegratorAnneal : public TwoStepIntegrator
   {
   ...
   public:
      ...
      * Constructor.
      */
      NvtLangevinIntegratorAnneal(Simulation& simulation);

      /**
      * Destructor.
      */
      ~NvtLangevinIntegratorAnneal();
