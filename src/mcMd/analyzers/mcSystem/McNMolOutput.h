#ifndef MCMD_MC_NMOL_H
#define MCMD_MC_NMOL_H
...
namespace McMd
{
   ...
   */
   class McNMolOutput : public SystemAnalyzer<McSystem>
   {
   ...
   */
   template <class Archive>
   void McNMolOutput::serialize(Archive& ar, const unsigned int version)
